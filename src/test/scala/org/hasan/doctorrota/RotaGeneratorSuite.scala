...
class RotaGeneratorSuite extends AnyFunSuite with Matchers {
  test("should generate a rota") {
    ...
    doctor6.hoursAllocated should equal(175)
    doctor6.shifts should have size (14)

    val doctor7: Doctor = doctors(6)
    doctor7.name should equal("Name 7")
    doctor7.hoursAllocated should equal(175)
    doctor7.shifts should have size (14)

    val doctor8: Doctor = doctors(7)
    doctor8.name should equal("Name 8")
    doctor8.hoursAllocated should equal(175)
    doctor8.shifts should have size (14)

    val doctor9: Doctor = doctors(8)
    doctor9.name should equal("Name 9")
    doctor9.hoursAllocated should equal(175)
    doctor9.shifts should have size (14)

    val doctor10: Doctor = doctors(9)
    doctor10.name should equal("Name 10")
    doctor10.hoursAllocated should equal(175)
    doctor10.shifts should have size (14)
  }
}
