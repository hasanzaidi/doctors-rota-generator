...
//  }
  ...
  private def buildValidShifts(): ListBuffer[Shift] = {
    ...
    val shift12 = Shift(NIGHT, WEEKDAY, LocalDateTime.of(2020, 6, 27, 8, 30), LocalDateTime.of(2020, 6, 18, 21, 0))
    val shift13 = Shift(NIGHT, WEEKDAY, LocalDateTime.of(2020, 6, 28, 8, 30), LocalDateTime.of(2020, 6, 19, 21, 0))
    val shift14 = Shift(NIGHT, WEEKDAY, LocalDateTime.of(2020, 6, 29, 8, 30), LocalDateTime.of(2020, 6, 20, 21, 0))
    val shift15 = Shift(NIGHT, WEEKDAY, LocalDateTime.of(2020, 7, 1, 8, 30), LocalDateTime.of(2020, 7, 1, 21, 0))
    val shift16 = Shift(NORMAL, WEEKDAY, LocalDateTime.of(2020, 7, 3, 8, 30), LocalDateTime.of(2020, 6, 15, 21, 0))
